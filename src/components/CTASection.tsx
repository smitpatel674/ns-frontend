  ...
  return (
    <section className="container-wide py-32 border-t border-current/10 gsap-fade-up">
      <div className="flex flex-col gap-0">
        <p className="text-xs uppercase tracking-[0.2em] opacity-40 mb-6" data-animate="fade-up">Get In Touch</p>

        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-0">
          <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-medium leading-[0.85] tracking-tighter" style={{ fontFamily: "Author, sans-serif", ...motionDelay(1, 90) }} data-animate="fade-up">
        ...
        <p className="text-lg opacity-70 max-w-2xl leading-relaxed" data-animate="fade-up" style={motionDelay(3, 90)}>
